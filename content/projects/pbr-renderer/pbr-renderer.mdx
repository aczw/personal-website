...
<div class="480:grid-cols-2 grid grid-cols-1 gap-pad">
  ![Zero metallicness, a little roughness](sphere-no-metallic.png) ![Full
  metallicness, more roughness](sphere-full-metallic.png)
</div>
...
<div class="480:grid-cols-2 grid grid-cols-1 gap-pad">
  ![Zero displacement on black obsidian block](obsd-none.png) ![Full
  displacement of obsidian block.](obsd-some.png)
</div>
