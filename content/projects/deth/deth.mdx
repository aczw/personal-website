...
metadata:
  tech:
    ...
    - C#
  link:
    href: https://pennupgrade.itch.io/deth
    text: Play on itch.io
  sourceHref: https://github.com/geant04/deth
  date: October 2023
cover:
  img: deth.png
...
<figure class="bleed-wide">
  ![Preview showing every possible tile placement and the tiling rules for
  them.](rule-tileset.png)
  <figcaption>
    **Tiling rules.** The window on the left shows every single possible
    combination.
  </figcaption>
</figure>
...
<div class="bleed-wide">
  <VideoGif
    content={{ collection: "projects", folder: "deth" }}
    name="gun-switch-anim"
    hasWebM
  />
</div>
...
I don't regret this experience one bit. It's rare to have a "legit" reason to stay awake for 24 hours (procrastinating on homework doesn't count).

Apart from the itch.io link above, you can also play the game from [UPGRADE's website](https://pennupgrade.com/games/deth). GLHF!
