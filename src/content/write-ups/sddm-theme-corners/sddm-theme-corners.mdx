...
I've made it publicly available on my GitHub. Since then, it's gotten quite a few stars and forks, which makes me happy because people are enjoying something I made :\)
...
This sounds like a diss. None of this is intended to be a diss. They're popular for a reason. Subjectively, the design just didn't appeal to me. Plus, without these projects I would've had no idea where to start programming! (More on this later.) After some tinkering and iterating, the final result looks like this:
