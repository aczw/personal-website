...
> It's still alive at [old.charl.sh](https://old.charl.sh), by the way. Why am I still keeping it alive? I dunno, I'm still attached to it. It has sentimental value. It's like, `v1`, you know.
...
![Sketch of a dialog box with some text and a button in two color schemes. Drawn in Procreate.](./v1-procreate.png)
...
The second reason is the tech stack I used. I had recently stumbled upon [Theo](https://twitter.com/t3dotgg) and decided to use [`create-t3-app`](https://create.t3.gg) to jumpstart my site. I realize now that it did not fit my needs _at all_. I completely ignored its helpful integrations with tRPC, Prisma, and Auth.js.
...
[Astro](https://astro.build/) advertises itself as a framework that focuses on content-first websites. That immediately caught my eye. And, the more I read, the more I was convinced. It checked all the boxes in my head.
...
- Integrations with UI frameworks like React, meaning I could gradually learn and transfer everything over. Related, but this also enables cool features like [component islands](https://docs.astro.build/en/concepts/islands/).
...
I spent a good while experimenting with different homepage layouts, playing with the color and text. Going in, I was heavily inspired by Google's [Material You](https://m3.material.io/) design language, with its odd shapes, large padding, and rounded corners.
...
![The new homescreen, with information contained in rounded blocks.](./v2-projects.png)

![The projects page, with images arranged in a grid and tags displayed underneath visually.](./v2.png)
