...
I used to make my resumes like any other person, using Google Docs (or Microsoft Word if you're that kinda guy).[^1] I'm gonna go out on a limb and say that no one likes the formatting and layout step—I can't believe it's 2024 and the general advice is to "press tab until the right side of your text aligns with the right side of the page."
