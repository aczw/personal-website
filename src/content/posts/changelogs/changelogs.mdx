---
title: Changelogs
blurb: Reading the update notes for the stuff you use is always exciting. What's changed? What's not? Just for fun, I've added them to this site as well.
...
This project became an exercise in _doing shit_ to _do shit._ Literally, note to self, publicly: _stop caring._ Not everything needs to be shown off and flaunted. This mindset has been very detrimental and I've been taking steps to change it. This is one of the ways.

Basically, I want to stop forcing things. Sorry this became an impromptu therapy session. But this is my own website and I get to do whatever I want :)
