---
title: "Introducing RCW, my first Unity game"
blurb: Endless minigame about matching colors and text together. I tried to focus on a super clean UI and simple controls. It's also playable from your browser!
tags:
  - Unity
  - C#
  - Figma
...
<VideoGif
  folder="rcw"
  vids={[{ name: "flashing-btns-figma.mp4", type: "video/mp4" }]}
/>
...
<VideoGif
  folder="rcw"
  vids={[{ name: "main-menu-ani-btns.mp4", type: "video/mp4" }]}
/>
