...
<VideoGif
  folder="sddm-theme-corners"
  vids={[{ name: "power-session-buttons.mp4", type: "video/mp4" }]}
/>
...
<VideoGif
  folder="sddm-theme-corners"
  vids={[{ name: "user-picture-inputs.mp4", type: "video/mp4" }]}
/>
...
<VideoGif
  folder="sddm-theme-corners"
  vids={[{ name: "incorrect-login-anim.mp4", type: "video/mp4" }]}
/>
