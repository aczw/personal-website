...
<div class="mdx-full">
  <iframe
    width="100%"
    height="450px"
    src="https://www.are.na/charles-zw/charleszw-com-v6/embed"
...
<figure class="mdx-outdent">
  <div class="rounded-lg border-y-(length:--border-w) border-style desktop:border-x-(length:--border-w)">
...
Try it now with the image below. (Note: not available on mobile because you can just, like, pinch.)

<figure class="mdx-outdent">
  ![Steam Deck is lying on a bed. On the screen is the start menu for Catanks, a
  game.](catanks-deck.jpg)
  <figcaption>
    __Click the image (on desktop) to zoom in.__ Also, what's this? A picture of
    our recently released game, Catanks, [free now on
