...
blurb: To easily share my Spotify profile, I like to use link shortener services. I got tired of how they always stopped working, so the obvious solution here was to write my own.
posted: 2024-04-24T08:10:00-04
updated: 2024-10-01T04:14:00-04
cover:
...
To get around that, I use link shorteners, but I've found that they're very unreliable, and often shut down/stop working. With the recent release of Astro Studio and [Astro DB](https://go.czw.sh/zqqVN3L), I thought this was the perfect chance to test it out... and hopefully my woes once and for all.
