...
One interesting thing here is that no HTML exists for the `/[...slug]` route. I only have Astro frontmatter code that gets executed on the server. If no short URL exists in the database, then I simply redirect to the home page.
