...
> **From the future:** because it doesn't exist anymore, here are screenshots of what `/`, `/projects`, and `/portfolio` looked like respectively.
>
> ![The new homepage](./homepage.png)
>
