...
subtitle: duk an goos clim montan.
blurb: A stress-inducing two player game made in 24 hours for UPGRADE's Spring 2024 Game Jam.
metadata:
  tech:
    - Unity
    - C#
...
<figure class="bleed-wide">
  ...
  />
  <figcaption>
    **Unlocking double jump.** Confession: the progress ring is supposed to
    positioned directly over Duck and Goose, but it broke for some reason and I
