...
After the jam we also produced a WebGL build so now you can directly play the game from [UPGRADE's website](https://pennupgrade.com/games/duckgooseduckgoose). So grab a friend and go have some fun!
