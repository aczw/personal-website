...
<Gif className="mx-auto w-[600px]">
  <source src="/projects/sddm-theme-corners/power-session-buttons.webm"></source>
</Gif>
...
Tying everything together are subtle animations that animate popups in and out of view. I especially like what happens when you enter an incorrect login:
