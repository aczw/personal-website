...
> My site uses the .sh TLD, which doesn't seem to have a <Link href="https://deployment.rdap.org/#:~:text=.sh" newTab>RDAP Server</Link> configured. You could do a WHOIS lookup from the [official registry website](https://www.nic.sh/whois-search.htm?domain_name=charl.sh), but I'm hiding my information anyway :)
