...
I've always wanted a personal site. Wouldn't it be cool to *own* a website and be a part of the internet? At the time, I had just begun learning web dev as well, and there was no better way to put my skills to the test than to create my own site.

A more pragmatic reason is that I can now have a centralized location to showcase and talk about projects I've done (like this one). As a college student, it's nice to be able to directly link to stuff I want to show off.
...
Fun fact: what you're looking at is the third version of my site.
