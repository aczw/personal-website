...
<Image src={import("./project-tags-before.png")} alt="A jumbled mess" class="rounded-md" />
...
<Image src={import("./project-tags-after.png")} alt="Tags are smooshed together and placed on one line, completely unreadable" />
