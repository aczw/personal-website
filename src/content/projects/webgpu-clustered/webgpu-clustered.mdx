...
Here's a graph demonstrating how the frame rate is impacted by the number of lights present in the scene. Clustered deferred rendering manages to have the best frames per second at 5000 lights.

<div class="mdx-full">
  ![Graph comparing frame rates for the naive, Forward+, and deferred rendering
  methods.](graph.png)
</div>
