---
name: 𝑫𝑶𝑶𝑹
subtitle: Stylized rendering in Unity
...
Another requirement we had to meet was to create an additional shader that animated over time. But, this was already a given for me; if you look at any in-game footage, the textures are always "shifting" around.

It's a bit hard to explain, so here's a YouTube video.

<figure class="mdx-full">
  <YouTube id="2D1VBDjamoA" title="OMORI - Sweetheart" start={182} />
  <figcaption>
    Here's the [direct link](https://youtu.be/2D1VBDjamoA?t=182) if the embed
    doesn't work.
  </figcaption>
</figure>
...
<div class="grid grid-cols-2 gap-pad-2">
  ![White square with lighter black scribbles all over it.](tex-light.png)
  ![White square with heavier black scribbles all over it.](tex-heavy.png)
</div>
...
<figure class="mdx-outdent">
  ![Staircase-like graph from the Graphtoy window](triwave.png)
  <figcaption>
    **Staggered triangle wave.** I used [Graphtoy](https://graphtoy.com) to
    figure out values before programming it.
  </figcaption>
</figure>
...
<figure class="mdx-full">
  <VideoGif
    content={{ collection: "projects", folder: frontmatter.slug }}
    name="door-anim-tex"
    hasWebM
  />
  <figcaption>
    The green-yellow-red color scheme is for testing out the highlight, midtone,
    and shadow colors.
  </figcaption>
</figure>
...
<figure class="mx-auto">
  <Image
    ...
    alt="Close-up of Mari's elbow, showcasing the multicolored
  outlines."
    data-no-zoom=""
  />
...
<div class="mdx-full">
  ![The same sphere and plane but now rendered using OMORI's
  outlines.](cool-outlines.png)
</div>
...
<div class="mdx-full">
  ![Unity scene view of the laptop screen with the shader
  applied.](laptop-screen.png)
</div>
...
<div class="mdx-full">
  ![Unity scene view of the background plane being projected along our camera's
  view vector.](bg-hack.png)
</div>
...
<div class="mdx-full">
  ![Alternative scene view when spacebar is pressed. Everything becomes darker,
  redder, and scarier.](horror.png)
</div>
...
- The laptop screen displays... [something else](https://github.com/aczw/hw04-stylization/blob/main/Assets/Textures/othermari.jpg).
