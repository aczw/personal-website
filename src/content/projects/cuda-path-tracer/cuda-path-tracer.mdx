...
<div class="grid grid-cols-1 gap-pad 480:grid-cols-2 bleed">
  <figure>
...
// GLSL/GLM refract expects the IOR ratio to be incident over target,
// so we treat the default as us starting from inside the material
...
|  **Real**   |           61.220            |
  ...
  <figcaption class="px-pad">Higher is better</figcaption>
</figure>
