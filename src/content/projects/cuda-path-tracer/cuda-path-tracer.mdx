...
<figure class="mdx-bleed mdx-outdent">
  <div class="grid grid-cols-1 gap-pad-2 sm:grid-cols-2">
...
<figure class="mdx-bleed mdx-outdent">
  <div class="grid grid-cols-2 desktop:gap-pad-2">
...
<div class="mdx-bleed grid grid-cols-1 gap-pad-2 sm:grid-cols-2">
  <figure>
...
<div class="mdx-bleed mdx-outdent grid grid-cols-1 gap-pad-2 sm:grid-cols-2">
  <figure>
