...
This was my first time using Unity and my first full game. Going into this project, I wasn't looking to create anything new or ground-breaking. My main goal was to familiarize myself with all aspects of the development process, and have the end result be something completely playable, polished, and cohesive.
...
The other thing I'm really proud of are the button animations. When the instructions or credits button is activated, the same button is used to go back to the start screen.
...
- **Shop system.** Earn currency for each game you play that can be spent on powerups (score multiplier, increased time, more lives, freeze time, etc.)
