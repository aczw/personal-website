...
metadata:
  ...
  link:
    ...
    text: Play the demo online on itch.io!
...
<div class="bleed-wide">
  <div class="overflow-hidden rounded-xl [&_lite-youtube]:max-w-none">
...
If you're reading this and have some free time, we would love more feedback! You can contact me directly via my socials or you can join the UPGRADE Discord server. The invite link can be found on [the club website](https://pennupgrade.com).
