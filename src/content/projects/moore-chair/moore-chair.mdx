...
After assigning geometry different materials and unfolding UVs, I exported the chair as a FBX and imported it into Painter.
...
I used Arnold to render. Unfortunately, Arnold GPU rendering requires [a NVIDIA GPU](https://help.autodesk.com/view/ARNOL/ENU/?guid=arnold_for_maya_am_Getting_Started_with_Arnold_GPU_html) and I have AMD, and I decided to try rendering on my laptop. This was a mistake.

It took me _15 hours to render 240 frames._ Each frame took ~2.5 minutes. So I'm never doing that again. But at least the end result looks nice!
