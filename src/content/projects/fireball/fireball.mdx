...
When I saw the next homework for our Procedural Graphics class was to make a "procedural fireball," I instantly knew where to get inspiration from: _Jibaku Shounen Hanako-kun_.[^1]
...
[^1]: I refuse to call it by its English name. If you see it you'll understand too.
